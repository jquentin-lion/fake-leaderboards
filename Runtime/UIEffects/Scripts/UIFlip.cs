...
namespace LionStudios.Suite.Leaderboards.Fake.UIEffects
{
    ...
    public class UIFlip : BaseMeshEffect
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="LionStudios.Suite.Leaderboards.Fake.UIEffects.UIFlip"/> should be flipped horizontally.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="LionStudios.Suite.Leaderboards.Fake.UIEffects.UIFlip"/> should be flipped vertically.
        /// </summary>
        /// <value><c>true</c> if be flipped horizontally; otherwise, <c>false</c>.</value>

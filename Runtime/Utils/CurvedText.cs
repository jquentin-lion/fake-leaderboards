...
namespace LionStudios.Suite.Leaderboards.Fake
{
    ...
    public class CurvedText : MonoBehaviour
    {
        ...
        public void SetCurveForceMeshUpdate()
        {
        ...
        public void SetCurve()
        {
            ...
            //! ADV.Log(ADVLogType.GameDebug, "CurvedText: text description: {0}", textInfo.textComponent.text);
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                Vector3 offsetToMidBaseline = new Vector2((vertices[vertexIndex + 0].x + vertices[vertexIndex + 2].x) / 2, textInfo.characterInfo[i].baseLine * baseLineOffset);
